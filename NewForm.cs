...
namespace Bon
{
    public partial class NewForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                try { if (!string.IsNullOrEmpty(_ans1)) DataAccess.InsertNewFormAnswer(DataAccessConnectionString(), _username, "Hydration", _ans1); } catch { }
            }
            catch { }
            ...
            try
            {
                var pref = new FoodPrefernces(_username, _ans1, _ans2, _ans3, _ans4);
                this.Hide();
